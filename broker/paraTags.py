...
class paraTags:
    ...
    distance_upper = 2 # 两辆无人车之间距离上限
    distance_lower = 0.5 # 两辆无人车之间距离下限
    connectivity = 0.6
    algChoose = 1 # 算法选择
    # **********读写路径**********
